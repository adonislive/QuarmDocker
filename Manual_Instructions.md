# Quarm Docker — Manual Instructions

This document covers manual setup and technical reference. If you are setting up for the first time, the setup script in the main folder is the easier path — see [README.md](README.md).
...
> Always run a database backup before doing this — see the scripts in your OS folder under config/.
